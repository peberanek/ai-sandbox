...
Source: https://openwebui.com/f/justinrahb/google_genai

* Function Name: `Google GenAI`
* Function ID: `google_genai`
* Function Description: `Gemini Manifold Pipe`

Changelog:
* Fixed `Error: Invalid model name format`. It seems there was a breaking change in
  the Google API. Model names now start with `google_gemini.` instead
  of `google_genai.`.
